...
**Spring Boot Starter for geoip**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/geoip-spring-boot-starter)](https://github.com/easy-4-java/geoip-spring-boot-starter)
...
> **Artifact ID**：`geoip-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**geoip-spring-boot-starter** is a Spring Boot starter that integrates **geoip** for applications using geoip. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume geoip capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using geoip |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for geoip |
| JDK | `17` |
| Coordinates | `io.github.easy4j:geoip-spring-boot-starter:3.1.x.20260527-SNAPSHOT` |
| Config Prefix | `geoip` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers geoip beans automatically |
| Property Binding | ✅ Stable | Binds `geoip.*` to `GeoIP2Properties` |
| `NodeCache` bean | ✅ Stable | Auto-registered via GeoIP2AutoConfiguration |
...
|---|---|---|
| `NodeCache` | classpath + property | not created |
| `DatabaseReader` | classpath + property | not created |
| `GeoIP2Template` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `geoip.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl geoip-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `geoip.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/geoip-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/geoip-spring-boot-starter)
